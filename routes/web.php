...
Route::resource('newsletter', NewsletterMailController::class);
...
Route::get('/admin', function() {
    ...
    return view('home', compact('testimonials', 'intros', 'promotions', 'teams', 'services', 'abouts', 'videos','contacts','navbars', 'icons', 'boutons', 'banners', 'users'));
